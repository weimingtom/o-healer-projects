...
package{
	public class IInput{
		...
		static public const BUTTON_D:int    = 2;
		static public const BUTTON_U:int    = 3;
		static public const BUTTON_ROTATE:int = 4;
		//System
		static public const BUTTON_RESET:int = 5;
		//Num
		static public const BUTTON_NUM:int  = 6;
