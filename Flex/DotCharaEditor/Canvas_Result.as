...
package{
	...
	public class Canvas_Result extends Canvas{
		...
		//#サイズ
		public var SIZE_W:int = 32;
		public var SIZE_H:int = 32;
		...
		public function Canvas_Result(in_W:int = 32, in_H:int = 32){
			//Size
			{
				SIZE_W = in_W;
				SIZE_H = in_H;
			...
			//BG
			{
				m_Root.addChild(new BackGroundAnim(SIZE_W, SIZE_H, SIZE_H/4));
			}
